...
DEVICE_TYPES = [dev_id for dev_id in hibike_message.DEVICES]
...
def test_with_random_data(func, arg_func, kwarg_func=lambda: {}, times=5, *args, **kwargs):
    ...
    for _ in range(times):
        # Do not expand list arguments out
        generated_args = arg_func()
        if isinstance(generated_args, tuple):
...
def random_uid():
    ...
    return uid_type << 72 | random.getrandbits(8) << 64 | random.getrandbits(64)
...
class CobsTests(unittest.TestCase):
    ...
    def test_encode_decode(self):
        ...
        test_with_random_data(assert_encode_decode_equal, CobsTests.gen_cobs_data, times=100)
...
class ParamsTests(unittest.TestCase):
    ...
    def test_idempotence(self):
        ...
        test_with_random_data(assert_params_same,
...
class ParsingTests(unittest.TestCase):
    ...
    def test_parse_valid_packets(self):
        ...
        for func in self.MESSAGE_GENERATORS.values():
            if func is not None:
                test_with_random_data(assert_parse_is_not_none,
                                      func, times=100)
    ...
    def test_parse_bad_checksum(self):
        ...
        for func in self.MESSAGE_GENERATORS.values():
            if func is not None:
                ...
                test_with_random_data(assert_parse_is_none, wrapped_func, times=100)
    ...
    def test_parse_idempotence(self):
        ...
        for func in self.MESSAGE_GENERATORS.values():
            if func is not None:
                test_with_random_data(assert_parse_idempotent, func, times=100)
